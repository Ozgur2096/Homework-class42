...
// All promise functions started to run at the same time and it was not clear which one would resolve first. After resolution, the other functions continued to run because there was no condition or statement that can stop them.
